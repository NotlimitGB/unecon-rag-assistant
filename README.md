...
Проект содержит frontend, backend API, ручную загрузку утверждённых HTML-страниц и PDF СПбГЭУ, детерминированное чанкирование и локальный плотный поиск через BGE-M3 и FAISS. PDF обрабатываются только при наличии текстового слоя. Генерация ответов пока не реализована.
