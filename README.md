...
- `data/source_manifest.json` — утверждённые источники; `data/processed/html/` и `data/processed/pdf/` — нормализованные документы; `data/processed/chunks/` — локальные чанки; `data/processed/index/` — локальный индекс.
